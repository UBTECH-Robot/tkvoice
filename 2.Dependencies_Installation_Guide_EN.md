...
```
Working Directory/
└── tkvoice_release_0.3.12_0316_095057.tar  (Installation Package)
```
...
> After executing uninstall.sh, the ~/tkvoice_release_0.3.12_0316_095057 directory will be deleted, meaning the uninstallation script itself will also be deleted. However, the ~/tkvoice_release_0.3.12_0316_095057.tar file will not be deleted.
...
RELEASE_DIR="tkvoice_release_0.3.12_0316_095057"  # Extract directory name
```

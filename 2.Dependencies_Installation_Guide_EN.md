...
```
Working Directory/
└── tkvoice_release_0.3.6_0313_170837.tar  (Installation Package)
```
...
nvidia/
├── tkvoice_release_0.3.6_0313_170837.tar  (Installation Package)
└── tkvoice_release_0.3.6_0313_170837/
    └── install.sh
```
...
> After executing uninstall.sh, the ~/tkvoice_release_0.3.6_0313_170837 directory will be deleted, meaning the uninstallation script itself will also be deleted. However, the ~/tkvoice_release_0.3.6_0313_170837.tar file will not be deleted.
...
RELEASE_DIR="tkvoice_release_0.3.6_0313_170837"  # Extract directory name
```
...
rm -rf tkvoice_release_0.3.6_0313_170837
...
bash /home/nvidia/tkvoice_release_0.3.6_0313_170837/res/ollama/uninstall_ollama.sh
...
tar -xf tkvoice_release_0.3.6_0313_170837.tar \
    tkvoice_release_0.3.6_0313_170837/res/ollama/

bash tkvoice_release_0.3.6_0313_170837/res/ollama/install_ollama.sh
```

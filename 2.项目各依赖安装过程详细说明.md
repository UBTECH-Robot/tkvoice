...
```
工作目录/
└── tkvoice_release_0.3.6_0313_170837.tar  (安装包)
```
...
> 执行uninstall.sh 后 ~/tkvoice_release_0.3.6_0313_170837 目录会删除掉，也就是卸载脚本自身也会删除掉，但是 ~/tkvoice_release_0.3.6_0313_170837.tar 文件不会删除。
...
RELEASE_DIR="tkvoice_release_0.3.6_0313_170837"  # 解压目录名
```

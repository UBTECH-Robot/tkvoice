...
# ASR 和 TTS 目前是对接的 azure 的服务，需要两个参数：
# SPEECH_KEY 也就是调用服务所需要的 key
# ENDPOINT 也就是服务所在的节点，一般来说都是尽可能使用地理上相近的节点，延迟会低一些

LANGUAGE=zh-CN
# 该参数为微软 ASR 识别的语种，可选项参考: https://learn.microsoft.com/zh-cn/azure/ai-services/speech-service/language-support?tabs=stt

VOICE_NAME=sl-SI-RokNeural
# 该参数为语音合成的语种，可参考: https://learn.microsoft.com/zh-cn/azure/ai-services/speech-service/language-support?tabs=tts

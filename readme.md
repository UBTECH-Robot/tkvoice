...
1. 先从本地电脑上将 tkvoice_release_0.2.26_1201_164512.tar 传到 41.2 的 Orin 板：
```bash
...
# 再注意，执行uninstall.sh 后 ~/tkvoice_release_0.2.26_1201_164512 目录会删除掉，也就是卸载脚本自身也会删除掉，但是 ~/tkvoice_release_0.2.26_1201_164512.tar 文件不会删除
```

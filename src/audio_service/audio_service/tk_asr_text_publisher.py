...
class ASRTextPublisher(Node):
    def __init__(self):
        ...
        self.get_logger().info("ASRTextPublisher 节点已启动，正在订阅 audio_sentence_frames")
        ...
        self.asr_service = AzureSpeechAdapter()
...
def main(args=None):
    ...
    tk_audio_process = ASRTextPublisher()
...
# ros2 launch audio_service asr_text_launch.py

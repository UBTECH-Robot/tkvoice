...
1. **Build:**
```bash
cd tkvoice_release_0.3.24_0324_090527
...
release_dir=tkvoice_release_0.3.24_0324_090527

1. Transfer `tkvoice_release_0.3.24_0324_090527.tar` from your local computer to the Orin board at 41.2:

```bash
scp tkvoice_release_0.3.24_0324_090527.tar nvidia@192.168.41.2:/home/nvidia
```
...
2. After logging in to the Orin board at 41.2, first extract only the `install.sh` script from `tkvoice_release_0.3.24_0324_090527.tar`. Other extraction will be done by the installation script as needed:

```bash
tar -xvf tkvoice_release_0.3.24_0324_090527.tar tkvoice_release_0.3.24_0324_090527/install.sh
```
...
# Also note that after executing uninstall.sh, the ~/tkvoice_release_0.3.24_0324_090527 directory 
# will be deleted, including the uninstall script itself. However, the 
# ~/tkvoice_release_0.3.24_0324_090527.tar file will not be deleted.
```
...
# View logs
tail -f /home/nvidia/tkvoice_release_0.3.24_0324_090527/tkvoice.log
```

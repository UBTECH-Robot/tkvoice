...
1. Transfer `tkvoice_release_0.3.14_0316_180106.tar` from your local computer to the Orin board at 41.2:
...
2. After logging in to the Orin board at 41.2, first extract only the `install.sh` script from `tkvoice_release_0.3.14_0316_180106.tar`. Other extraction will be done by the installation script as needed:
...
# Also note that after executing uninstall.sh, the ~/tkvoice_release_0.3.14_0316_180106 directory 
# will be deleted, including the uninstall script itself. However, the 
# ~/tkvoice_release_0.3.14_0316_180106.tar file will not be deleted.
```

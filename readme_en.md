...
1. **Build:**
```bash
cd tkvoice_release_0.3.15_0317_152304
...
release_dir=tkvoice_release_0.3.15_0317_152304

1. Transfer `tkvoice_release_0.3.15_0317_152304.tar` from your local computer to the Orin board at 41.2:

```bash
scp tkvoice_release_0.3.15_0317_152304.tar nvidia@192.168.41.2:/home/nvidia
```
...
2. After logging in to the Orin board at 41.2, first extract only the `install.sh` script from `tkvoice_release_0.3.15_0317_152304.tar`. Other extraction will be done by the installation script as needed:

```bash
tar -xvf tkvoice_release_0.3.15_0317_152304.tar tkvoice_release_0.3.15_0317_152304/install.sh
```
...
# Also note that after executing uninstall.sh, the ~/tkvoice_release_0.3.15_0317_152304 directory 
# will be deleted, including the uninstall script itself. However, the 
# ~/tkvoice_release_0.3.15_0317_152304.tar file will not be deleted.
```
...
# View logs
tail -f /home/nvidia/tkvoice_release_0.3.15_0317_152304/tkvoice.log
```
